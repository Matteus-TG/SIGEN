...
public class Alterar_Senha extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jBConfirmar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/salvar.png"))); // NOI18N
    ...
    private void jBConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBConfirmarActionPerformed
        if (jPFSenhaAtual.getText().equals(senha)) {

            try {
                if (jPFNovaSenha.getText().equals(jPFSenha2.getText())) {
                    LoginDAO ldao = new LoginDAO();
                    ldao.alterPass(login, jPFNovaSenha.getText());
                } else {
